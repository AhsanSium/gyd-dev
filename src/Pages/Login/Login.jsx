...
import { Navigate, useNavigate, useLocation, useHistory } from "react-router-dom";
...
const Login = () => {
    ...
    const { handleFacebookSignIN, signInWithGithub, loginUser, signInWithGoogle, authError, registerUser } = useAuth();
    ...
    console.log('login re-rending', authError);
                                    ...
                                    <div className="col-lg-6">
                                        <div className="card-body p-md-5 mx-md-4">
                                            <div className="text-center">
                                                <img src={logoImage} className="card-img" alt="logo" />
                                                <h4 className="mt-1 mb-5 pb-1">Get Your Doctor</h4>
                                            </div>
                                            {
                                                !newUser ?
                                                    <div>
                                                        ...
                                                        <form onSubmit={(e) => handleLoginSubmit(e)}>
                                                            ...
                                                            <div className="d-flex align-items-center justify-content-center pb-4">
                                                                ...
                                                                <button onClick={() => handleCreateAccount()} type="button" className="btn btn-outline-danger">Create new</button>
                                                            </div>
